...
{
    public class SwordbotSurvivor : SurvivorBase<SwordbotSurvivor>
    {
        //used to load the assetbundle for this character. must be unique
        public override string assetBundleName => "swordbotbundle"; //if you do not change this, you are giving permission to deprecate the mod

        //the name of the prefab we will create. conventionally ending in "Body". must be unique
        public override string bodyName => "SwordbotBody"; //if you do not change this, you get the point by now

        //name of the ai master for vengeance and goobo. must be unique
        public override string masterName => "SwordbotMonsterMaster"; //if you do not
        ...
        public override BodyInfo bodyInfo => new BodyInfo
        {
            ...
            crosshair = Asset.LoadCrosshair("Loader"),
        ...
        private void AddSecondarySkills()
        {
            ...
            SkillDef secondarySkillDef1 = Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                baseRechargeInterval = 9f, //should be 9f
                baseMaxStock = 1,
        ...
        public override void InitializeCharacterMaster()
        {
            ...
            SwordbotAI.Init(bodyPrefab, masterName);
